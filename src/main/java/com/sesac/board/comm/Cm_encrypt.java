...
public class Cm_encrypt {
    public static String encryptSha256(String value) { //단방향
    ...
    public static String encryptAes(String str, String key) throws Exception { //양방향
     ...
     * key = 암호화시 사용했던 키워드
     */
    public static String decryptAes(String str, String key) throws Exception { //복호화
